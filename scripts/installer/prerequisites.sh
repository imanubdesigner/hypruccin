...
run_command "pacman -S --needed --noconfirm adw-gtk-theme alacritty alsa-firmware alsa-utils avahi bat btop btrfs-progs cava chromium clang cliamp curl discord dosfstools dust elephant-all evince eza exfatprogs fastfetch fcitx5 fcitx5-gtk fcitx5-qt fd ffmpeg ffmpegthumbnailer fzf glib2 glow gnome-themes-extra gobject-introspection gpu-screen-recorder gum gvfs gvfs-mtp gvfs-nfs gvfs-smb gst-plugin-pipewire hyprland-preview-share-picker-git imagemagick imv inetutils inotify-tools jdk-openjdk kernel-modules-hook lazygit less libadwaita libgsf librsvg libyaml libsecret libwebp limine-mkinitcpio-hook limine-snapper-sync localsend-bin llvm luarocks kvantum-qt5 meld mise mpv nautilus nautilus-python man-db neovim nodejs npm noto-fonts noto-fonts-emoji noto-fonts-cjk nss-mdns obsidian pacman-contrib pamixer pipewire pipewire-alsa pipewire-jack pipewire-pulse plocate power-profiles-daemon poppler-glib python-pyquery python-terminaltexteffects ripgrep ruby rust spotify-launcher sd starship sushi swaybg swayosd tar tesseract tesseract-data-eng thermald tmux tree-sitter tree-sitter-cli ttf-ia-writer ttf-jetbrains-mono-nerd typora udisks2 ufw unzip walker wget wiremix wireplumber woff2-font-awesome xdg-terminal-exec xdg-user-dirs xsel xmlstarlet yaru-icon-theme yazi yt-dlp zoxide zsh zsh-completions zram-generator" "Install complete application suite (browsers, media, development, system tools)" "no"
